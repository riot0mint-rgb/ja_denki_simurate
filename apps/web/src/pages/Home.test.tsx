...
describe('ホーム画面', () => {
  it('入力開始ボタンを押すと onStartInput が呼ばれる', async () => {
    ...
    render(<Home onStartInput={onStartInput} onStartSimple={() => {}} onStartCoach={() => {}} onStartInsights={() => {}} />)
  ...
  it('個人情報を扱わないことを、お客様に伝わる言葉で明示する（CLAUDE.md ルール9）', () => {
    render(<Home onStartInput={() => {}} onStartSimple={() => {}} onStartCoach={() => {}} onStartInsights={() => {}} />)
...
describe('入り口の分岐', () => {
  it('かんたん試算にも入れる', async () => {
    ...
    render(<Home onStartInput={() => {}} onStartSimple={onStartSimple} onStartCoach={() => {}} onStartInsights={() => {}} />)
...
describe('商談ナビへの入り口', () => {
  it('商談ナビをひらける', async () => {
    ...
    render(<Home onStartInput={() => {}} onStartSimple={() => {}} onStartCoach={onStartCoach} onStartInsights={() => {}} />)
