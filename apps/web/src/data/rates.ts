...
import { RatePlan } from '@ja-denki-simulator/calc-core'
...
export const jadenRatenA: RatePlan = {
  ...
  fuelAdjustment: { status: 'unconfirmed' },
  renewableLevy: { status: 'unconfirmed' },
  tax: { status: 'unconfirmed' },
  roundingRule: {
    method: 'round',
    unit: 'yen',
    sourceFile: '【中国】JAでんき料金メニュー定義書（家庭用）＜20261001＞.pdf'
...
export const jadenRatenS: RatePlan = {
...
export const chugokuRatenA: RatePlan = {
