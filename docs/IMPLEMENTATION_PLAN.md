...
| 出典据え置きの検知（転記ミス対策） | ✅ 完了 |
| 回帰テストによる関門（1201点） | ✅ 完了 |
| `scripts/rate-intake.ts`（試算表xlsx→改定案） | ⏳ 未実装 |
...
| 5 デプロイ設定 | ✅ 完了 | |
| **Phase A** | **✅ 完了** | |
| 6 料金改定レビュー | ⚙️ 一部実装（設計変更） | 差分レポートまで完了 |
...
**最終更新**: 2026-08-20（フェーズ2・6・7の設計変更、Phase A 完了）
**次回確認**: フェーズ6の rate-intake 着手時
