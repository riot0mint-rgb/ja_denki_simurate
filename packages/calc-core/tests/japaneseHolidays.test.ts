...
describe('1970年の検針期間（0 を偽値として弾かない）', () => {
  it('epoch 起点の日付でも数えられる', () => {
    // 実用上まず無いが、!start で弾くと 1970-01-01 だけ null になる。
    // countMonthDays は === null で判定しており、揃っていなかった
    expect(countMeterPeriodDays('1970-01-01', '1970-01-31')?.days).toBe(31);
    expect(countMonthDays('1970-01-01', '1970-01-31', 1)).toBe(31);
  });
});
