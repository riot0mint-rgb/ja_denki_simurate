 ...
 *
 * **どちらが正か: 本実装（Decimal の厳密値を切り捨て）が約款どおり。**
 * 2026-08-20 に電気需給約款（低圧家庭用・2018年9月1日実施）3.(5) で確認した。
 *
 *   料金、その他の計算における合計金額の単位は１円とし、その端数は切り捨てます。
 *
 * 「合計が整数のとき1円引く」ような規定はどこにもない。Excel の 52 点は表計算側の
 * 浮動小数点誤差であって、請求されるべき金額ではない。
