...
③の「シミュレーション結果明細 VSナイトホリデー」で中国電力側の基本料金
(1)(2)(3) に**数式が入っていない**（J8:J10 が空欄。26年4月版・7月版とも）。
0として計算すると中国電力側が過小になりJAの削減額を小さく見せるため、
`baseChargeUpTo10Kw: null` として `unsupported` を返している。
**定義書で基本料金（10kWまで／10kW超過）が分かれば解除できる。**
